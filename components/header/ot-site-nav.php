<div class="site-nav flex md:grid grid-cols-12 items-center justify-between py-5">
    <nav class="col-span-5 justify-self-end mb-7 hidden md:block" aria-label="Main left">
        <?php echo get_template_part( '/components/ot-menu-items', null, array(
            'menu'=>'primary-left',
            'class' => 'text-white list-none flex'
        ) ) ?>
    </nav>
    ...
    <nav class="col-span-5 shrink-0 pr-4 md:pr-0 justify-self-start items-center mb-7 flex " aria-label="Main right">
        <?php echo get_template_part( '/components/ot-menu-items', null, array(
            'menu'=>'primary-right',
            'class' => 'text-white list-none flex hidden md:block'
        ) ) ?>
        <div class="flex shrink-0 items-center md:hidden h-fit mr-5">
            <button data-nav_mobile_open>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-list w-8 h-8"
                    viewBox="0 0 16 16">
        ...
        <div class="pl-5  shrink-0 border-l border-l-white font-light ">
            <a href="tel:+48126889000" class="flex items-center font-light text-white py-2 overflow-hidden keep-line">
                <figure>
    ...
    <nav data-nav_mobile class="w-full flex flex-col mobile-nav">
        ...
        <?php echo get_template_part( '/components/ot-menu-items', null, array(
            'menu'=>'primary-left',
            'class' => 'text-white list-none flex flex-col px-0 gap-3 mb-3'
        ) ) ?>
        <?php echo get_template_part( '/components/ot-menu-items', null, array(
            'menu'=>'primary-right',
            'class' => 'text-white list-none flex flex-col px-0 gap-3'
        ) ) ?>
    </nav>
</div>