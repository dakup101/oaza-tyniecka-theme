...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.querySelector(".map")) {
    ...
    // Krk
    L.marker([50.05187, 19.89938], { icon: oazaIcon }).addTo(map);
    // Random
    L.marker([50.06465, 19.94552], { icon: oazaIcon }).addTo(map);
    // Everywhere
    L.marker([50.08258, 19.89608], { icon: oazaIcon2 }).addTo(map);
  }
});
