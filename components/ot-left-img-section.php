...
<div class="flex justify-start relative">
    <figure class="absolute right-0 top-0 h-full z-20 img-right flex items-center justify-center overflow-hidden">
    ...
    <figure class=" absolute top-8 right-8 h-full img-right -z-10 flex justify-center items-end">
        <div class="w-full h-full bg-gray">
        </div>
    </figure>
    <figure class="bg-gray-lighter h-full w-full -translate-x-1/2 -z-20 absolute left-0 top-0">
    </figure>
